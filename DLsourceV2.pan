...
___ PROCEDURE .ModifyRecord ____________________________________________________
/*
local fName1,KeyStroke1
fName1=info("formname") 
...
*/
___ ENDPROCEDURE .ModifyRecord _________________________________________________
...
case info("formname")="nikos" 
    if fName = "lot" and KeyStroke = chr(9)
        field «amtrec»
