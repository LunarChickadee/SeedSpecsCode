...
loop
gettext "999 or 100?",nineOrHundred
stoploopif val(nineOrHundred) =100 or val(nineOrHundred) = 999
repeatloopif val(nineOrHundred) ≠100 or val(nineOrHundred) ≠ 999
while forever


case val(nineOrHundred)=999
    arraylinebuild recordarray,"^","",(«preferred supplier»+"^"+str(«cat #»)+"^"+latin+"^"+common+"^"+«gmo test»+"^"+«seed color»+"^"+str(temp)+"^"+str(«1st»)+"^"+str(«2nd»)
                                                    ...
                                                    +"^"+«indigenous royalties»+"^"+«breeder royalties»+"^"+ossi+"^"+pvp+"^"+str(«year of introduction»)+«Breeder»)
