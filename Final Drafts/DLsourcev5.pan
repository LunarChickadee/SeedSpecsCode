...
___ PROCEDURE .startTimer ______________________________________________________
global timeStart

timeStart=timepattern(now()
___ ENDPROCEDURE .startTimer ___________________________________________________

___ PROCEDURE .endTimer ________________________________________________________
global timeEnd,timeDiff

timeEnd=now()

timeDiff=timedifference(timepattern(timeStart,"hh:mm:ss"),timepattern(timeEnd,"hh:mm:ss"))

displaydata timeDiff+" seconds"
___ ENDPROCEDURE .endTimer _____________________________________________________

___ PROCEDURE .test ____________________________________________________________
local typeDate
  GetText "Use Month Number for This Year or MMYY for last year",typeDate
 displaydata datevalue(val(datepattern(today(),"YYYY")),val(typeDate),1)
 displaydata datepattern(date(typeDate),"mmyy")
...
___ PROCEDURE .sortCatInt ______________________________________________________
;formulafill ?(str(«cat #») contains ".",val(str(«cat #») [1,"."][1,-2]),«cat #»)

field CatInt
formulafill val(str(«cat #»)[1,"."])
;CatInt=replace(CatInt,".","")

___ ENDPROCEDURE .sortCatInt ___________________________________________________

___ PROCEDURE checkCatInt ______________________________________________________
global intArray
intArray=""
field CatInt

arrayselectedbuild intArray, ¶, "",CatInt


displaydata intArray
___ ENDPROCEDURE checkCatInt ___________________________________________________

___ PROCEDURE GetCatOrder ______________________________________________________
field sparenumber2
...
___ ENDPROCEDURE GetCatOrder ___________________________________________________

___ PROCEDURE .checkbox ________________________________________________________

___ ENDPROCEDURE .checkbox _____________________________________________________
